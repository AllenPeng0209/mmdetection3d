_base_ = [
    '../_base_/models/deeproute_3dssd.py', '../_base_/datasets/deeproute-3d.py',
...
class_names = ['Car']
point_cloud_range = [0, -80, -5, 80, 80, 3]
input_modality = dict(use_lidar=True, use_camera=False)
db_sampler = dict(
    data_root=data_root,
    info_path=data_root + 'deeproute_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(filter_by_difficulty=[-1], filter_by_min_points=dict(Car=0)),
    classes=class_names,
