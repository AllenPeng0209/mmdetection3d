...
def main():
    ...
    #pcd_path = "/home/jiamiaoxu/data/code/detection_evaluation/detection_Jiamiao/second/cone_benchmark/pcd"

    info_path = "/media/deeproute/HDISK/dataset/lidar/label/20190412_rain_1"
