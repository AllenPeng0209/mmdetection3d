...
def get_eval(gt_loc, dt_loc, gt_boxes, dt_boxes, gt_names, dt_names, timeStamp, gt_occlusion, gt_ignore, dt_scores):
    ...
    #thresholds = get_thresholds(dt_scores, len(gt_boxes), num_sample_pts=41) 
...
def compute_eval(config_path, eval_path, info_path, det_path, pcd_path, save_path, gt_occl_path, ignore_path, pool_num):
    ...
    for frame_id in tqdm(range(len(info_text_names))):
        ...
        gt_loc, gt_dims, gt_yaws, gt_ids, gt_names, gt_scores = readInfo_per_frame(info_path, timeStamp, name_to_label, interest_labels, False)
        ...
        dt_loc, dt_dims, dt_yaws, dt_ids, dt_names , dt_scores= readInfo_per_frame(det_path, timeStamp, name_to_label, interest_labels, False)
        ...
        #res.append(get_eval(gt_loc, dt_loc, gt_boxes, dt_boxes, gt_names, dt_names, timeStamp,  gt_occlusion, gt_ignore, dt_scores))
        res.append(pool.apply_async(get_eval, (gt_loc, dt_loc, gt_boxes, dt_boxes, gt_names, dt_names, timeStamp, gt_occlusion, gt_ignore, dt_scores)))
...
def deeproute_eval():
    list_path = "/home/data/deeproute/val.list.20191216"
    info_path = "/home/data/deeproute/validating/label/"
    pcd_path = "/home/data/deeproute/validating/pcd/"
    det_path = "/home/yanlun/mmdetection3d/work_dirs/pp_secfpn_deeproute/evaluation/detections"
    eval_path = "/home/yanlun/mmdetection3d/work_dirs/pp_secfpn_deeproute/evaluation/results-only"
    gt_occl_path = "/home/data/deeproute/validating/evaluation/occl/occlusion_detection.pkl"
    ignore_path = "/home/data/deeproute/validating/evaluation/occl/ignore_detection.pkl"
    save_path = "/home/data/deeproute/validating/evaluation/occl/" 
    ...
    result_dic = compute_eval(config_path, eval_path, info_path, det_path, pcd_path, save_path, gt_occl_path, ignore_path, pool_num=1)
...
def main():
    ...
    mode = sys.argv[3]
    list_path = "/home/yanlun/mmdetection3d/data/deeproute/"+mode+".list.20191216"
    info_path = "/home/yanlun/mmdetection3d/data/deeproute/"+mode+"ing/label/"
    pcd_path = "/home/yanlun/mmdetection3d/data/deeproute/"+mode+"ing/pcd/"
    #det_path = "/home/yanlun/mmdetection3d/work_dirs/"+model_name+"/evaluation/detections/"+mode
    det_path = "/home/yanlun/detections-0.001"
    eval_path = "/home/yanlun/mmdetection3d/work_dirs/"+model_name+"/evaluation/results-only/"+mode
    gt_occl_path = "/home/yanlun/mmdetection3d/data/deeproute/"+mode+"ing/evaluation/occl/occlusion_detection.pkl"
    ignore_path = "/home/yanlun/mmdetection3d/data/deeproute/"+mode+"ing/evaluation/occl/ignore_detection.pkl"
    save_path = "/home/yanlun/mmdetection3d/data/deeproute/"+mode+"ing/evaluation/occl/"
    config_path = "/home/yanlun/mmdetection3d/mmdet3d/core/evaluation/deeproute_utils/configs/detection.eval.config"
    if len(sys.argv) > 1:
