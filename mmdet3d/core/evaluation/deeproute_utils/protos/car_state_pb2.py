...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x0f\x63\x61r_state.proto\x12\x10\x64\x65\x65proute.common\x1a\x0egeometry.proto\"\xdb\x06\n\x08\x43\x61rState\x12\x11\n\ttime_meas\x18\x01 \x01(\x10\x12,\n\x08position\x18\x02 \x01(\x0b\x32\x1a.deeproute.common.Vector3f\x12\x30\n\x0cvelocity_enu\x18\x03 \x01(\x0b\x32\x1a.deeproute.common.Vector3f\x12\x30\n\x0cvelocity_flu\x18\x04 \x01(\x0b\x32\x1a.deeproute.common.Vector3f\x12\x32\n\x0eroll_pitch_yaw\x18\x05 \x01(\x0b\x32\x1a.deeproute.common.Vector3f\x12\x38\n\x14\x61ngular_velocity_flu\x18\x06 \x01(\x0b\x32\x1a.deeproute.common.Vector3f\x12\x34\n\x10\x61\x63\x63\x65leration_flu\x18\x07 \x01(\x0b\x32\x1a.deeproute.common.Vector3f\x12\x19\n\x11\x66ront_wheel_angle\x18\x08 \x01(\x02\x12\r\n\x05speed\x18\t \x01(\x02\x12:\n\x0bturn_signal\x18\n \x01(\x0e\x32%.deeproute.common.CarState.TurnSignal\x12\x1a\n\x12warning_blinker_on\x18\x0b \x01(\x08\x12\x33\n\x04gear\x18\x0c \x01(\x0e\x32%.deeproute.common.CarState.GearStatus\x12<\n\x0c\x64riving_mode\x18\r \x01(\x0e\x32&.deeproute.common.CarState.DrivingMode\x12\x14\n\x0clongitudinal\x18\x0e \x01(\x02\x12\x17\n\x0f\x61\x63\x63_over_ground\x18\x0f \x01(\x02\"0\n\nTurnSignal\x12\r\n\tNONE_TURN\x10\x00\x12\x08\n\x04LEFT\x10\x01\x12\t\n\x05RIGHT\x10\x02\"b\n\nGearStatus\x12\x0b\n\x07INVALID\x10\x00\x12\x08\n\x04PARK\x10\x01\x12\x0b\n\x07REVERSE\x10\x02\x12\x0b\n\x07NEUTRAL\x10\x03\x12\t\n\x05\x44RIVE\x10\x04\x12\x07\n\x03LOW\x10\x05\x12\x0f\n\x0bUNSPECIFIED\x10\x06\"L\n\x0b\x44rivingMode\x12\n\n\x06MANUAL\x10\x00\x12\x15\n\x11LONGITUDINAL_AUTO\x10\x01\x12\x10\n\x0cLATERAL_AUTO\x10\x02\x12\x08\n\x04\x41UTO\x10\x03')
  ,
...
_CARSTATE_TURNSIGNAL = _descriptor.EnumDescriptor(
  name='TurnSignal',
  full_name='deeproute.common.CarState.TurnSignal',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_CARSTATE_GEARSTATUS = _descriptor.EnumDescriptor(
  name='GearStatus',
  full_name='deeproute.common.CarState.GearStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_CARSTATE_DRIVINGMODE = _descriptor.EnumDescriptor(
  name='DrivingMode',
  full_name='deeproute.common.CarState.DrivingMode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_CARSTATE = _descriptor.Descriptor(
  name='CarState',
  full_name='deeproute.common.CarState',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='time_meas', full_name='deeproute.common.CarState.time_meas', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='position', full_name='deeproute.common.CarState.position', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='velocity_enu', full_name='deeproute.common.CarState.velocity_enu', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='velocity_flu', full_name='deeproute.common.CarState.velocity_flu', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='roll_pitch_yaw', full_name='deeproute.common.CarState.roll_pitch_yaw', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='angular_velocity_flu', full_name='deeproute.common.CarState.angular_velocity_flu', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='acceleration_flu', full_name='deeproute.common.CarState.acceleration_flu', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='front_wheel_angle', full_name='deeproute.common.CarState.front_wheel_angle', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='speed', full_name='deeproute.common.CarState.speed', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='turn_signal', full_name='deeproute.common.CarState.turn_signal', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='warning_blinker_on', full_name='deeproute.common.CarState.warning_blinker_on', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='gear', full_name='deeproute.common.CarState.gear', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='driving_mode', full_name='deeproute.common.CarState.driving_mode', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='longitudinal', full_name='deeproute.common.CarState.longitudinal', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='acc_over_ground', full_name='deeproute.common.CarState.acc_over_ground', index=14,
...
CarState = _reflection.GeneratedProtocolMessageType('CarState', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:deeproute.common.CarState)
  })
